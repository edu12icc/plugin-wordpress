<div class="wrap">
    <h2><?php _e( 'Agregar Proceso Vigente', 'bcie' ); ?></h2>
      <form action="" method="post" class="formulario">
        ...
        <tbody>
          ...
          <tr class="row-">
                      ...
                      <td>
                          <input type="number" name="" id="" class="regular-text" placeholder="<?php echo esc_attr( '', 'bcie' ); ?>" value="<?php 'echo esc_attr( $item-> ); '?>" />
                      </td>
                  </tr>
        ...
        <?php wp_nonce_field( '' ); ?>
        <?php submit_button( __( 'Agregar', 'bcie' ), 'primary', 'submit_vigente' ); ?>
    </form>
</div>
