<div class="wrap">
    <h2><?php _e( 'Modificar Proceso Concluido', 'bcie' ); ?></h2>
    ...
    <form action="" method="post" class="formulario">
        ...
        <table class="form-table">
            <tbody>
              ...
              <tr class="row-Executor">
                  <th scope="row-Executor">
                      <label for="Executor"><?php _e( 'Nombre de la Línea', 'bcie' ); ?></label>
                  </th>
                  <td>
                      <input type="text" name="Executor" id="Executor" class="regular-text" placeholder="<?php echo esc_attr( '', 'bcie' ); ?>" value="<?php echo esc_attr( $item->LineName ); ?>" />
                  </td>
              </tr>
                  ...
                  <td>
                      <select class="regular-text" name="ProcessResult">
                        <option value="">Selecione Tipo</option>
                         <option value="0" <?php if ($item->ProcessResult == 0) {
                           echo "selected";
                         } ?>>Adjudicado <?php $item->ProcessResult ?></option>
                         <option value="1" <?php if ($item->ProcessResult == 1) {
                           echo "selected";
                         } ?>>Desierto <?php $item->ProcessResult ?></option>
                         <option value="2" <?php if ($item->ProcessResult == 2) {
                           echo "selected";
                         } ?>>Fracasado <?php $item->ProcessResult ?></option>
                         <option value="3"<?php if ($item->ProcessResult == 3) {
                           echo "selected";
                         } ?>>Cancelado <?php $item->ProcessResult ?></option>
                      </select>
                  </td>
                </tr>
        ...
        <?php wp_nonce_field( '' ); ?>
        <?php submit_button( __( 'Modificar', 'bcie' ), 'primary', 'submit_concluido' ); ?>
